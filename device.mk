...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/system/android.hardware.vulkan.version-1_1.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.hardware.vulkan.version-1_1.xml \
